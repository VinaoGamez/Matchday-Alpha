...
export const NATIONAL_TEAMS = Object.freeze({
  FRA: { code: 'FRA', name: 'França', iso: 'fr', fifaRank: 1, block: 1, namePool: 'França' },
  ARG: { code: 'ARG', name: 'Argentina', iso: 'ar', fifaRank: 2, block: 1, namePool: 'Argentina' },
  ENG: { code: 'ENG', name: 'Inglaterra', iso: 'eng', fifaRank: 3, block: 1, namePool: 'Inglaterra' },
  BRA: { code: 'BRA', name: 'Brasil', iso: 'br', fifaRank: 6, block: 1, namePool: 'Brasil' },
  POR: { code: 'POR', name: 'Portugal', iso: 'pt', fifaRank: 5, block: 1, namePool: 'Portugal' },
  NED: { code: 'NED', name: 'Holanda', iso: 'nl', fifaRank: 7, block: 1, namePool: 'Holanda' },
  ESP: { code: 'ESP', name: 'Espanha', iso: 'es', fifaRank: 8, block: 1, namePool: 'Espanha' },
  BEL: { code: 'BEL', name: 'Bélgica', iso: 'be', fifaRank: 9, block: 1, namePool: 'Bélgica' },
  GER: { code: 'GER', name: 'Alemanha', iso: 'de', fifaRank: 10, block: 1, namePool: 'Alemanha' },
  CRO: { code: 'CRO', name: 'Croácia', iso: 'hr', fifaRank: 11, block: 1, namePool: 'Croácia' },
